            ...
            [{block name="checkout_basketcontents_basketitem"}]
                ...
                <tr id="table_cartItem_[{$smarty.foreach.basketContents.iteration}]">
                    ...
                    [{block name="checkout_basketcontents_basketitem_removecheckbox"}]
                        [{if $editable}]
                            <td class="checkactive checkbox text-center" style="display:table-cell;margin:-5px;padding:0;vertical-align:middle;">
                                <input type="checkbox" name="aproducts[[{$basketindex}]][remove]" value="1" style="margin:-5px;float:none;">
                            </td>
                        [{/if}]
                    [{/block}]
