        ...
        [{oxhasrights ident="TOBASKET"}]
            ...
            [{else}]
                [{block name="dd_layout_page_header_icon_menu_minibasket_title"}]
                    <p class="title">
                        <strong>[{if $oxcmp_basket->getItemsCount() == 1 }] [{$oxcmp_basket->getItemsCount()}] [{oxmultilang ident="ITEM_IN_BASKET"}]
                          [{else}]
                            ...
                            [{foreach from=$oxcmp_basket->getContents() name=miniBasketList item=_product}]
                                [{block name="widget_minibasket_product"}]
                                    ...
                                    <tr>
                                        ...
                                        <td class="price text-center">[{$_product->getFTotalPrice()}]&nbsp;[{$currency->sign}] </td>
                                    </tr>
                                [{/block}]
                            [{/foreach}]
                            <tr>
