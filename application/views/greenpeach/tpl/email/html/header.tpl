                                                        ...
                                                        <tr>
                                                            <td class="six sub-columns text-pad-left">
                                                                ...
                                                                <a href="[{$oConfig->getShopUrl(null,false)}]" title="[{$shop->oxshops__oxtitleprefix->value}]">
                                                                    <img src="http://pruebas.greenpeach.mx/out/greenpeach/img/logo-greenpeachsuperfoods.svg" border="0" hspace="0" vspace="0" alt="[{$shop->oxshops__oxname->value}]" align="texttop" style="width: 95px; height: 92px;">
                                                                </a>
                                                            </td>
