...
">
            ...
            <?php else: ?>
                    ...
                    <p class="title">
                        <strong><?php if ($this->_tpl_vars['oxcmp_basket']->getItemsCount() == 1): ?> <?php echo $this->_tpl_vars['oxcmp_basket']->getItemsCount(); ?>
 <?php echo smarty_function_oxmultilang(array('ident' => 'ITEM_IN_BASKET'), $this);?>
