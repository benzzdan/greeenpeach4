<?php /* Smarty version 2.6.28, created on 2017-04-05 02:46:29
        ...
        <nav id="mainnav" class="navbar navbar-default" role="navigation">
                    ...
                    <div class="navbar-header">
                            ...
                            <!--logo -->
                                ...
                                <?php $this->assign('slogoImg', $this->_tpl_vars['oConf']->getImageUrl(false,null,null,'logo-greenpeachsuperfoods.png')); ?>
...
" id="logo_gp">
                                    <img src="<?php echo $this->_tpl_vars['slogoImg']; ?>
" alt="<?php echo $this->_tpl_vars['oxcmp_shop']->oxshops__oxtitleprefix->value; ?>
" style="<?php if ($this->_tpl_vars['sLogoWidth']): ?>width:<?php echo $this->_tpl_vars['sLogoWidth']; ?>
px;<?php endif; ?><?php if ($this->_tpl_vars['sLogoHeight']): ?>height:<?php echo $this->_tpl_vars['sLogoHeight']; ?>
px;<?php endif; ?>; top: -24px; position: relative;">
                                </a>
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul id="navigation" class="nav navbar-nav">
                                ...
                                <li <?php if ($this->_tpl_vars['homeSelected'] == 'true'): ?>class="active"<?php endif; ?>>
                                    <a class="hvr-underline-from-center" href="<?php echo $this->_tpl_vars['oViewConf']->getHomeLink(); ?>
...
"><?php echo $this->_tpl_vars['oTopCont']->oxcontents__oxtitle->value; ?>
                                        ...
                                        <li class="<?php if ($this->_tpl_vars['homeSelected'] == 'false' && $this->_tpl_vars['ocat']->expanded): ?>active<?php endif; ?><?php if ($this->_tpl_vars['ocat']->getSubCats()): ?> dropdown<?php endif; ?>">
                                            <a class="hvr-underline-from-center" href="<?php echo $this->_tpl_vars['ocat']->getLink(); ?>
...
"><?php echo $this->_tpl_vars['osubcat']->oxcategories__oxtitle->value; ?>
                                                                    ...
                                                                    <!-- <a class="hvr-underline-from-center" href="<?php echo $this->_tpl_vars['osubcat']->getLink(); ?>
"><?php echo $this->_tpl_vars['osubcat']->oxcategories__oxtitle->value; ?>
</a> -->
                                                                </li>
                                                            <?php endif; ?>
