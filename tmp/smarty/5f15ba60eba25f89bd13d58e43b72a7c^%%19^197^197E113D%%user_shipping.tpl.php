...
">
            ...
            <?php echo smarty_function_oxscript(array('add' => "$( '.dd-add-delivery-address' ).click( function() {  $('.dd-available-addresses .dd-edit-shipping-address').remove(); $( this ).find( 'label.btn' ).button('toggle'); } );"), $this);?>
            ...
            <?php echo smarty_function_oxscript(array('add' => "$( '.dd-edit-shipping-address' ).click(function(){ $( '#shippingAddressForm' ).show(); $( 'html, body' ).animate( { scrollTop: $( '#shippingAddressForm' ).offset().top - 80 }, 600 ); } );"), $this);?>
                ...
                <div class="row dd-available-addresses" data-toggle="buttons">
                    <?php $_from = $this->_tpl_vars['aUserAddresses']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <?php if ($this->_tpl_vars['address']->isSelected()): ?>
                                        <button class="btn btn-warning btn-xs hasTooltip pull-right dd-edit-shipping-address" title="<?php echo smarty_function_oxmultilang(array('ident' => 'CHANGE'), $this);?>
">
